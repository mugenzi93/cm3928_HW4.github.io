...
rf_model = randomForest(factor(survived) ~ pclass + gender + age + sib_sp + parch +
                        ...
                        data = train, mtry = 2, importance = TRUE)
...
In this figure, the test error is displayed as a function of number of trees. Each colored line correspond to `Out-of-Bag`, `died`, and `survived` error rates.
