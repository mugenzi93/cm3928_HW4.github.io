...
The influential point indicated that a male faculty with only 2 years of working experience had an extremely high salary compared to others. I fitted two models both with and without the point and eventually dropped that point to fit the final model. For collinearity, since most of the variables were categorical, it was acceptable that the VIF of those variables became higher.
