...
For further analysis, Model 1 was stratified by each of the included confounders. While being stratified by the departments, the results showed that males were more likely to receive higher baseline salaries than females in the Department of Physiology and Medicine. The gender difference still existed after adjusting for other confounders except for experienced subjects. While adjusting for experienced subjects, I found that there was no significant difference in baseline salary between both genders.

# Discussion

The hypothesis made by the medical professor that there is a significant pay gap between male and female professors was partially supported by this study. The data indicate that gender has a relatively strong association with the baseline payment of salary (1994). In addition, its interaction with the number of years of experience also contributes to different wages. However, the final model of the increase in salary reveals that, except for gender, all the other variables are independently and strongly associated with the increase in salary from 1994 to 1995, which suggests that there is no gender pay gap in the wage increase. 
...
There are several limitations to this study. First, this study was restricted to faculties in the Houston college of medicine. The dynamics of employees of other institutions or organizations may be quite different. Second, the research dataset did not include the age and race of subjects. Therefore, the results may not be generalizable to schools with a different distribution of age and race. Finally, I cannot exclude the possibility that the association we observed is due to a certain sociological environment that the school is embedded in. If, for example, the school is in a community where sexism is common and embedded in their subconsciousness and the environment they grew up in, my result, therefore, cannot be generalized to other communities.


# Conclusion

In this cross-sectional study that involved 261 medical professors, I found that gender was significantly associated with salary setting at the baseline level (1994) but that a professor’s salary increase from 1994 to 1995 was not necessarily dependent on gender. Therefore, the claim made by the Houston college of medicine professor that there exists gender discrimination in setting salary was in part supported by the first model but refuted by the second model when it comes to salary increase with regard to both genders from 1994 to 1995.
